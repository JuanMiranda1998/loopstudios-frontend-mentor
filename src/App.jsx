...
function App() {
  ...
  const SOCIAL_LINKS = ["/images/icon-facebook.svg","/images/icon-twitter.svg","/images/icon-pinterest.svg","/images/icon-instagram.svg"]
  const PROJECTS = [
    {
      id: 1,
      title: 'Deep earth',
      bgUrlMobile: '/images/mobile/image-deep-earth.jpg',
      bgUrlDesktop: '/images/desktop/image-deep-earth.jpg',
    },
    {
      id: 2,
      title: 'Night arcade',
      bgUrlMobile: '/images/mobile/image-night-arcade.jpg',
      bgUrlDesktop: '/images/desktop/image-night-arcade.jpg',
    },
    {
      id: 3,
      title: 'Soccer team VR',
      bgUrlMobile: '/images/mobile/image-soccer-team.jpg',
      bgUrlDesktop: '/images/desktop/image-soccer-team.jpg',
    },
    {
      id: 4,
      title: 'The grid',
      bgUrlMobile: '/images/mobile/image-grid.jpg',
      bgUrlDesktop: '/images/desktop/image-grid.jpg',
    },
    {
      id: 5,
      title: 'From up above VR',
      bgUrlMobile: '/images/mobile/image-from-above.jpg',
      bgUrlDesktop: '/images/desktop/image-from-above.jpg',
    },
    {
      id: 6,
      title: 'Pocket borealis',
      bgUrlMobile: '/images/mobile/image-pocket-borealis.jpg',
      bgUrlDesktop: '/images/desktop/image-pocket-borealis.jpg',
    },
    {
      id: 7,
      title: 'The curiosity',
      bgUrlMobile: '/images/mobile/image-curiosity.jpg',
      bgUrlDesktop: '/images/desktop/image-curiosity.jpg',
    },
    {
      id: 8,
      title: 'Make it fisheye',
      bgUrlMobile: '/images/mobile/image-fisheye.jpg',
      bgUrlDesktop: '/images/desktop/image-fisheye.jpg',
    },
  ];
  ...
  return (
    ...
    >
      <div className="hero py-10 px-6 md:px-32 md:py-16 bg-hero-mobile md:bg-hero-desktop bg-cover relative">
            ...
            {menuOpen ? (
              <div className="px-6 py-10 bg-black text-white absolute top-0 left-0 bottom-0 right-0">
                <div className="flex flex-row justify-between items-start">
                  ...
                  >
                    <img className="w-5" src="/images/icon-close.svg" alt="" />
                  </button>
                </div>
                <div className="mt-24">
        ...
        <div className="my-44 md:mt-32 md:mb-16 md:w-[750px] px-8 md:px-12 py-8 md:py-14 border-2 border-white">
          <h1 className="text-[2.5rem] md:text-7xl leading-10 md:tracking-wider text-left font-title uppercase text-white">
